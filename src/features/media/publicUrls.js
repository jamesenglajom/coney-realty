...
// The bucket's three library folders — flat pools of arbitrarily-named
// webp files, browsed/picked from wherever a photo is needed (the admin
// media page itself, or a picker embedded in the testimonials/leaderboard/
...
export const MEDIA_FOLDERS = ["properties", "agent-headshots", "agent-half-body"];
