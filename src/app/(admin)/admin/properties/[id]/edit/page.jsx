...
export default async function EditPropertyPage({ params }) {
	...
	const [property, assignableUsers] = await Promise.all([getPropertyById(id), listAssignableUsers()]);
	...
	return (
		<div>
			...
			<PropertyForm mode="edit" property={property} assignableUsers={assignableUsers} />
		</div>
	);
}
